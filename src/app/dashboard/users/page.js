                ...
                >
                  ...
                  <TableCell>
                    <Chip
                      ...
                      size="small"
                      sx={{
                        bgcolor: row?.status === 'Active' ? '#FF6D00' : row?.status === null ? '#FF6D00' : '#E0E0E0',
                        color: row?.status === 'Active' ? 'white' : row?.status === null ? 'white' : 'text.primary',
                        minWidth: 80,
                        height: '30px'
                      }}
                    />
                  ...
                  <TableCell>{dynamicWeirdFormat(row?.points)}</TableCell>
