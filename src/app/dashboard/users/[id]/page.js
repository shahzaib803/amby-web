...
import { deleteUser, supabaseAdmin } from '../../../../lib/supabaseAdmin';
...
export default function EditUserPage({ params }) {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      accountFormik.setValues({
        ...
        type: profile?.subscription_tier || 'Free',
  ...
  const addPoints = (amount) => {
    accountFormik.setFieldValue(
      'points',
      Number(accountFormik.values.points || 0) + amount
    );
  };
            ...
            <form onSubmit={accountFormik.handleSubmit}>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                ...
                <Box sx={{ display: 'flex', gap: 2, mt: -2 }}>
                  <Button onClick={() => addPoints(20)} variant="outlined" size="small" sx={{ minWidth: '80px', borderColor: '#e0e0e0', color: 'text.primary' }}>+20</Button>
                  <Button onClick={() => addPoints(50)} variant="outlined" size="small" sx={{ minWidth: '80px', borderColor: '#e0e0e0', color: 'text.primary' }}>+50</Button>
                  <Button onClick={() => addPoints(100)} variant="outlined" size="small" sx={{ minWidth: '80px', borderColor: '#e0e0e0', color: 'text.primary' }}>+100</Button>
                </Box>
